...
return new class extends Migration
{
    ...
    {
        Schema::create('payment_invoices_old', function (Blueprint $table) {
            ...
            $table->boolean('order_number_type')->nullable()->default(false);
        });
    }
    ...
    {
        Schema::dropIfExists('payment_invoices_old');
    }
};
